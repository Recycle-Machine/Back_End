...
class UsersSignupSerializer(serializers.Serializer):
    ...
    def send_confirmation_email(self, user):
        ...
        subject = f'Welcome @! Verified your account to start using the App'
        ...
        server.starttls()
        server.login("DjangoRestfulTest@gmail.com", "tomala34")
        server.sendmail("DjangoRestfulTest@gmail.com", user.email, content) '''
    ...
    def gen_verification_token(self, user):
        """ Create a JWT token that the user can use to verified the account """
